...
const (
	AgentService_SendMessage_FullMethodName = "/agentfab.v1.AgentService/SendMessage"
	AgentService_Heartbeat_FullMethodName   = "/agentfab.v1.AgentService/Heartbeat"
)
...
func (c *agentServiceClient) SendMessage(ctx context.Context, in *Message, opts ...grpc.CallOption) (*SendMessageResponse, error) {
...
func (UnimplementedAgentServiceServer) SendMessage(context.Context, *Message) (*SendMessageResponse, error) {
...
var AgentService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "agentfab.v1.AgentService",
	...
	Metadata: "agentfab/v1/agent.proto",
}
